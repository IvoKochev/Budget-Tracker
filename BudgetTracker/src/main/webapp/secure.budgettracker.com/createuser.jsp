...
<html>
    ...
    <!-- Mirrored from secure.budgettracker.com/createuser.php by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 12 Sep 2017 20:31:40 GMT -->
    ...
    <head>
        ...
        <link rel="shortcut icon" href="bticon.ico">
        <script src='../www.google.com/recaptcha/api.js'></script>


        <link rel="STYLESHEET" type="text/css" href="common/style_business.css">
        <link rel="STYLESHEET" type="text/css" href="sites/business/default25e1f.css?v=2">
        ...
        <style>
            ...
            .expandableitem
            {
                background: transparent url(sites/business/pics/side-expandable.html) no-repeat left top;
                height: auto;
            }
            .expandableitem div{
                background: transparent url(sites/business/pics/side-expandable.html) no-repeat left bottom;
            }
            .subnavigation{
        ...
        <script src="inc/header29f8f.js?v=6.1" type="text/javascript"></script>
        <script>
    ...
    <body leftmargin=0 rightmargin=0 topmargin=0 bottommargin=0 class="">
        ...
        <table cellpadding=0 cellspacing="0" width="100%"><tr><td>
                    <div id=pagedesc style=display:none; class=pagedesc>Please enter all information below. The fields with a red star are required to register.</div>
                            ...
                            <td valign=top class=centernavpage>
                                ...
                                <div class=mainbody>
                                    <table cellpadding="0" cellspacing="0" border="0" width="100%">
                                        ...
                                        <tr>
                                            <td style="font-size: 0px; width: 13px;" valign="top"><img src=sites/business/pics/leftsidefade.png></td>
                                            <td class=centermainbody valign="top">
                                                            ...
                                                            <td valign=top>
                                                                ...
                                                                <div class=subnavigation></div><div class=maincontentarea>			<table cellpadding=5 cellspacing=0 border=0>
                                                                        <form method="post" action="../RegistrationServlet"name="createuserfrm" onsubmit="return validateChars();">
                                                                            <input type="hidden" name="hostname" value="business">
                                                                            <input type=hidden name=vendorid value="1">
                                                                            <input type=hidden name=reference value="budgettrackerblog">
                                                                            <input type=hidden name=schoolid value="">
                                                                            <input type=hidden name=timezone value=13>
                                                                            <input type=hidden name=guest value="0">
                                                                            <input type=hidden name=blog value="0">
                                                                            <input type="hidden" name="trial" value="0">
                                                                            <tr>
                                                                                <td width=150><a class="redTxt">*</a> Email Address</td>
                                                                                <td><input type="text" name="emailaddress" value=""></td>
                                                                            </tr>
                                                                            <tr>
                                                                                <td><a class="redTxt">*</a> Password</td>
                                                                                <td><input type="password" class=textbox name="password" value=""> <i><span>(Must contain at least 8 characters)</span></i></td>
                                                                            </tr>
                                                                            <tr>
                                                                                <td><a class="redTxt">*</a> Re-Enter Password</td>
                                                                                <td><input type="password" class=textbox name="password2" value=""></td>
                                                                            </tr>
                                                                            <tr>
                                                                                <td>
                                                                                ...
                                                                                <td>
                                                                                    <div class="g-recaptcha" data-sitekey="6LemvywUAAAAAHYZabQdF0UUaLx7_WoA0QLUd20k"></div>
                                                                            ...
                                                                            <tr>
                                                                                <td></td>
                                                                                <td>
                                                                                    <a target=_new href="terms.html">Terms and Conditions</a>
                                                                                </td>
                                                                            </tr>
                                                                            <tr>
                                                                                <td></td>
                                                                                <td>
                                                                                    By clicking "I Agree" you agree and consent to Terms of Agreement listed above.		<br><br><input id="agreeBtn" class="button" type="submit" value="I Agree">&nbsp;&nbsp;&nbsp;
                                                                                    <input class="button cancelbutton" type="button" value="I Do Not Agree" onclick="notagree()">
                                                                                </td>
                                                                            </tr>
                                                                        </form>
                                                                    </table>
                                                                    ...
                                                                    <script>
                                                                        function notagree() {
                                                                            disagree = confirm("Are you sure you want to cancel the Terms of Agreement? Click cancel to continue registration.");
                                                                            if (disagree == true) {
                                                                        ...
                                                                        function validateChars() {
                                                                            ...
                                                                            var password = createuserfrm.password.value;
                                                                            var password2 = createuserfrm.password2.value;
                                                                            var emailaddress = createuserfrm.emailaddress.value;
                                                                            var numberfound = 0;

                                                                            if (password.length < 8) {
                                                                                alert("You must enter at least 8 characters for your password");
                                                                                return false;
                                                                            }

                                                                            if (password2 != password) {
                                                                                alert("The passwords you entered does not match.");
                                                                                createuserfrm.password.focus();
                                                                                createuserfrm.password.select();
                                                                                return false;
                                                                            }
                                                                            if (emailaddress != "") {
                                                                                if (emailaddress.indexOf('@') == -1) {
                                                                                    alert("Please enter a valid email address.");
                                                                                    createuserfrm.emailaddress.focus();
                                                                                    createuserfrm.emailaddress.select();
                                                                                    return false;
                                                                                }
                                                                                if (emailaddress.indexOf('.') == -1) {
                                                                                    alert("Email address does not contain a period.");
                                                                                    createuserfrm.emailaddress.focus();
                                                                                    createuserfrm.emailaddress.select();
                                                                                    return false;
                                                                                }	if (emailaddress.indexOf('fdsa') != -1 || emailaddress.indexOf('fdas') != -1 || emailaddress.indexOf('jkl;') != -1 || emailaddress.indexOf('fdsfds;') != -1) {
                                                                                    alert("Invalid email address entered.");
                                                                                    createuserfrm.emailaddress.focus();
                                                                                    createuserfrm.emailaddress.select();
                                                                                    return false;
                                                                                }
                                                                                var emaillen = emailaddress.length;
                                                                                var lastemailchar = emailaddress.charAt(emaillen - 1);
                                                                                if (lastemailchar == "@") {
                                                                                    alert("The last character in your email address cannot be an '@' symbol.");
                                                                                    createuserfrm.emailaddress.focus();
                                                                                    createuserfrm.emailaddress.select();
                                                                                    return false;
                                                                                }
                                                                                if (lastemailchar == ".") {
                                                                                    alert("The last character in your email address cannot be a period.");
                                                                                    createuserfrm.emailaddress.focus();
                                                                                    createuserfrm.emailaddress.select();
                                                                                    return false;
                                                                                }
                                                                            ...
                                                                            jQuery('#agreeBtn').attr('disabled','disabled');
                                                                            return true;
                                                                        }

                                                                    </script>
                                                                    <!-- Google Code for Create User Conversion Page -->
                                                                    <script type="text/javascript">
                                                                        /* <![CDATA[ */
                                                                        var google_conversion_id = 1071640502;
                                                                        var google_conversion_language = "en";
                                                                        var google_conversion_format = "3";
                                                                        var google_conversion_color = "EEEEEE";
                                                                        var google_conversion_label = "Fi05CM6WjgIQtt___gM";
                                                                    ...
                                                                    <div style="display:inline;">
                                                                        <img height="1" width="1" style="border-style:none;" alt="" src="../www.googleadservices.com/pagead/conversion/1071640502/index3a47.html?value=1.00&amp;currency_code=USD&amp;label=Fi05CM6WjgIQtt___gM&amp;guid=ON&amp;script=0"/>
                                                                    </div>
                                                                    </noscript>
                                                ...
                                                <noscript>
                                                <img height="1" width="1" style="display:none;" alt="" src="../analytics.twitter.com/i/adsct2d15.gif?txn_id=nunjd&amp;p_id=Twitter&amp;tw_sale_amount=0&amp;tw_order_quantity=0" />
                                                <img height="1" width="1" style="display:none;" alt="" src="../t.co/i/adsct2d15.gif?txn_id=nunjd&amp;p_id=Twitter&amp;tw_sale_amount=0&amp;tw_order_quantity=0" />
                                                </noscript>
                ...
                var f, n, i;w[u] = w[u] || [], f = function () {
                    var o = {ti: "5187968"};o.q = w[u], w[u] = new UET(o), w[u].push("pageLoad")}, n = d.createElement(t), n.src = r, n.async = 1, n.onload = n.onreadystatechange = function () {
                    var s = this.readyState;s && s !== "loaded" && s !== "complete" || (f(), n.onload = n.onreadystatechange = null)}, i = d.getElementsByTagName(t)[0], i.parentNode.insertBefore(n, i)
            })(window, document, "script", "../bat.bing.com/bat.js", "uetq");</script><noscript><img src="../bat.bing.com/action/08876.html?ti=5187968&amp;Ver=2" height="0" width="0" style="display:none; visibility: hidden;" /></noscript>
                                        ...
                                        <center>
                                            <div class="copyrightinfo">
                                                ...
                                                <div class="languages" align=center>
                                                    <a href="privacy.html" target=_new>Privacy Policy</a> |
                                                    <a href="terms.html" target=_new>Terms of Agreement</a>

                                                    <br>


                                                    <br/>&copy; 2003-2017 BudgetTracker, Inc. All Rights Reserved.
    ...
    <!-- Mirrored from secure.budgettracker.com/createuser.php by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 12 Sep 2017 20:31:41 GMT -->
</html>
