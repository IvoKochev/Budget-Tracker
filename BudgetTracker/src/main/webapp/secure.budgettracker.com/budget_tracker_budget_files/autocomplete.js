    ...
    { // response in json format?
      ...
      for(var i=0;i<results.length;i++)
      {
        if(results[i].hasChildNodes())
          this.aSug.push(  { 'id':results[i].getAttribute('id'), 'value':results[i].childNodes[0].nodeValue, 'info':results[i].getAttribute('info'), 'info2':results[i].getAttribute('info2'), 'info3':results[i].getAttribute('info3'), 'info4':results[i].getAttribute('info4') }  );
      }
    }
